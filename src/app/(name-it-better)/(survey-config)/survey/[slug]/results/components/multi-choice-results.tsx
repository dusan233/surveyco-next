...
const MultiChoiceQuestionResults = ({
  ...
  const resultsData = [
    ...
    },
    {
      ...
      percenteges: 40,
      answeredCount: 3,
      id: "dwqld1233qwpdwqpdqw",
    },
    {
      description: "Hello its me",
      percenteges: 40,
      answeredCount: 3,
      id: "123123dwqldqwpdwqpdqw",
    },
    {
      description: "Hello its me",
      percenteges: 40,
      answeredCount: 3,
      id: "d9090wqldqwpdwqpdqw",
    },
    {
      description: "Hello its me",
      percenteges: 40,
      answeredCount: 3,
      id: "d.mnnnnwqldqwpdwqpdqw",
    },
    {
      description: "Hello its me",
      percenteges: 40,
      answeredCount: 3,
      id: "d090909kkkwqldqwpdwqpdqw",
    },
    {
      description: "Hello its me",
      percenteges: 40,
  ...
  ].filter((dsa) => dsa.answeredCount !== 1);
